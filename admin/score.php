...
$gamesInfo=PDOQuery($dbcon,"SELECT name FROM games WHERE id=?",[$gamesId],[PDO::PARAM_INT]);
...
<center>
<a href="<?=ROOT_PATH;?>admin/score/importScore.php?gamesId=<?=$gamesId;?>" class="btn btn-success" style="font-weight:bold;font-size:21px;width:96%"><i class="fa fa-upload" aria-hidden="true"></i> 成 绩 上 传</a><br><br>
<a href="<?=ROOT_PATH;?>admin/score/updateByItem.php?gamesId=<?=$gamesId;?>" class="btn btn-warning" style="font-weight:bold;font-size:21px;width:96%"><i class="fa fa-edit" aria-hidden="true"></i> 单 项 成 绩 修 改</a><br><br>
