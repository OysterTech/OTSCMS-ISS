...
<head>
  ...
  <title>设置运动员标记 / <?=$this->setting->get('systemName'); ?></title>
</head>
			...
			if(ret.code==200){
				...
				for(i in data){
					...
					html='<tr id="tr_'+info['id']+'">'
					    +'<td style="background-color:'+((info['run_group']%2==0)?'#C4E1FF':'#CEFFCE')+'">'+info['run_group']+'</td>'
					    +'<td>'+info['runway']+'</td>'
					    +'<td>'
