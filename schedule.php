...
<tr>
	<th style="text-align:center;font-size:16px;background-color:#C4E1FF" colspan="4">第 <?=$sceneId;?> 场<?php if($extraJson['scene'][$sceneId]!="") echo "（".$extraJson['scene'][$sceneId]."）";?></th>
</tr>
<tr>
