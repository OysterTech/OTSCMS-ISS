...
<div class="container">
	<div class="col-md-6 col-md-offset-3">
		<center><img src="<?=base_url('resource/images/longLogo.png');?>" style="display: inline-block;height: auto;max-width: 100%;"></center><br>
		<div class="panel panel-default">
			<div class="panel-heading">
				<h3 class="panel-title" style="text-align:center;line-height:23px;">欢迎登录<br><?=$this->Setting_model->get('systemName');?>（<a href='/admin/' style="color:blue;font-size:15px;">切换回V1.0</a>）</h3>
			</div>
