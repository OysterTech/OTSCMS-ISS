...
$query2=PDOQuery($dbcon,'SELECT id,name,extra_json,praise,start_date AS startDate,end_date AS endDate,venue,sponsor FROM games WHERE is_show=1 ORDER BY start_date DESC LIMIT '.($page-1)*$rows.','.$rows);
$list=$query2[0];
